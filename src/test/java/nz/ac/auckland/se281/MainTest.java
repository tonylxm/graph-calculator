...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void TY_C_equivalence_class_0() throws Exception {
      runCommands(OPEN_FILE, "c.txt", COMPUTE_EQUIVALENCE, 0);
      assertContains("Successfully opened graph from file c.txt");
      assertContains("[0]");
    }
    ...
    @Test
    public void TY_F_equivalence_class_2() throws Exception {
      runCommands(OPEN_FILE, "f.txt", COMPUTE_EQUIVALENCE, 2);
      assertContains("Successfully opened graph from file f.txt");
      assertContains("[1, 2, 3]");
    }

    @Test
    public void TY_F_equivalence_class_5() throws Exception {
    ...
    @Test
    public void TY_01_M_iterative_BFS() throws Exception {
    ...
    @Test
    public void TY_02_M_iterative_DFS() throws Exception {
    ...
    @Test
    public void TY_03_M_recursive_BFS() throws Exception {
    ...
    @Test
    public void TY_04_M_recursive_DFS() throws Exception {
    ...
    @Test
    public void TY_01_O_check_roots() throws Exception {
    ...
    // dfs and bfs of o.txt
    @Test
    public void TY_02_O_IBFS() throws Exception {
    ...
    @Test
    public void TY_03_O_RBFS() throws Exception {
    ...
    @Test
    public void TY_04_O_IDFS() throws Exception {
    ...
    @Test
    public void TY_05_O_RDFS() throws Exception {
